...
public class PoliticsFragment extends Fragment {
    ...
    public void onViewCreated(View v, Bundle savedInstanceState) {
        JSON_URL ="http://www.trinityapplab.in/RSS/submenu.php?menu=Politics";
        super.onViewCreated(v,savedInstanceState);
        view2= v;

        btn0 = (Button)view2.findViewById(R.id.affairs);
        btn1 = (Button)view2.findViewById(R.id.politics);

        showlist = (ListView)view2.findViewById(R.id.list_view_politics);
    ...
    private class LongOperation  extends AsyncTask<String, Void, Void> {
            ...
            try {
                ...
                try {
...

                    {
                        ...
                        books=obj1json.getJSONArray("Current Affairs");
                    ...
                    else if(flag==1)
                    {
                        ...
                        books=obj1json.getJSONArray("Indian Politics");
        ...
        protected void onPostExecute(Void unused) {
            ...
            if (Error != null) {
                ...
                ListView tv=(ListView)view2.findViewById(R.id.list_view_politics);

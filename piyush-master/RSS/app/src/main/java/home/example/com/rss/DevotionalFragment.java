...
public class DevotionalFragment extends Fragment {
	...
	public void onViewCreated(View v, Bundle savedInstanceState) {
		JSON_URL ="http://www.trinityapplab.in/RSS/submenu.php?menu=Spiritual";
		super.onViewCreated(v,savedInstanceState);
		view2= v;

		btn0 = (Button)view2.findViewById(R.id.Temples);
		btn1 = (Button)view2.findViewById(R.id.Gods);
		btn2 = (Button)view2.findViewById(R.id.Festivals);
		btn3 = (Button)view2.findViewById(R.id.books);
		showlist = (ListView)view2.findViewById(R.id.list_view_Temple);
 ...
 //	showlist2 = (ListView)view2.findViewById(R.id.list_view_festival);
	...
	obj1json=content2.getJSONObject(0);
	  books=obj1json.getJSONArray("Books");
		...
		books=obj1json.getJSONArray("Festivals");
		...
		else if(flag==2)
		{
			...
			books=obj1json.getJSONArray("Gods");
		...
		books=obj1json.getJSONArray("Temples");
		...
		protected void onPostExecute(Void unused) {
			...
			if (Error != null) {
				...
				ListView tv=(ListView)view2.findViewById(R.id.list_view_Temple);

...
public class AndroidWifiMonitor extends Activity {
    ...
    private BroadcastReceiver myWifiReceiver
        ...
        public void onReceive(Context arg0, Intent arg1) {
            ...
            if(networkInfo.getType() == ConnectivityManager.TYPE_WIFI){
                ...
                Toast.makeText(getApplicationContext(),"myWifiInfo",Toast.LENGTH_LONG).show();
                Intent i= new Intent(arg0, TrackerLocationService.class);
    ...
    public void toggleWiFi(boolean status) {
        ...
        if (status == true && !myWifiManager.isWifiEnabled()) {
            myWifiManager.setWifiEnabled(true);
        } else if (status == false && myWifiManager.isWifiEnabled()) {
    ...
    private void DisplayWifiState() {
     ...
     myNetworkInfo = myConnManager.getNetworkInfo(ConnectivityManager.TYPE_WIFI);
       ...
       myWifiInfo = myWifiManager.getConnectionInfo();
        ...
        TelephonyManager tm = (TelephonyManager) AndroidWifiMonitor.this.getSystemService(Context.TELEPHONY_SERVICE);
        ...
        if (myNetworkInfo.isConnected() && bssid.equalsIgnoreCase("6c:19:8f:ea:29:99")) {
            ...
            Toast.makeText(AndroidWifiMonitor.this, "you are in ASUS range", Toast.LENGTH_SHORT).show();
        ...
        //    new SendtoServer().execute();
            ...
            Toast.makeText(AndroidWifiMonitor.this, "you are out of Asus range", Toast.LENGTH_SHORT).show();
            textIp.setText("---");
            textSsid.setText("---");
            textBssid.setText("---");
            //textSpeed.setText("---");
            ...
            flag = 0;
            str1 = Integer.toString(flag);
            Toast.makeText(AndroidWifiMonitor.this, " Attendence " + str1, Toast.LENGTH_SHORT).show();
            //  new SendtoServer().execute();
...
//    }
    ...
    class SendtoServer extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dlg = new ProgressDialog(AndroidWifiMonitor.this);
